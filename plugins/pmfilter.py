        ...
        if total_results == 0:
            ...
            return await message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                        [[
                            InlineKeyboardButton('• ᴊᴏɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ •', url ='https://t.me/movies_group9')
                        ]]
                    )
                )
...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("• ᴊᴏɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ • ​ ", url=f"https://t.me/movies_group9")]]), disable_web_page_preview=True
    )
...
async def filter_qualities_cb_handler(client: Client, query: CallbackQuery):
    ...
    if settings["button"]:
        ...
        btn.insert(0, [
            InlineKeyboardButton("ᴘʀᴇᴍɪᴜᴍ", url=f"https://t.me/moviemarket_official/396"),
            InlineKeyboardButton("sᴇɴᴅ ᴀʟʟ", callback_data=f"sendfiles#{key}")
        ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("🔍 ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 🔎", url="https://t.me/movies_group9")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        try:
            ...
            if await db.has_premium_access(user_id):                               
                buttons = [[
                    ...
                    InlineKeyboardButton("• ᴡᴀᴛᴄʜ ɪɴ ᴡᴇʙ ᴀᴘᴘ •", web_app=WebAppInfo(url=lazy_stream))
                ]]
            else:
                ...
                buttons = [[
                    ...
                    InlineKeyboardButton("• ᴡᴀᴛᴄʜ ɪɴ ᴡᴇʙ ᴀᴘᴘ •", web_app=WebAppInfo(url=ph_link))
                ],[
    ...
    # don't change anything without contacting me @cryxelys
        ...
        buttons = [[
            InlineKeyboardButton('• ʙᴏᴛ ᴀᴅᴍɪɴ ᴄᴏᴍᴍᴀɴᴅꜱ •', callback_data='adminx')
        ], [
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴘʀᴇᴠ', callback_data='main'),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴇɴᴄʀʏᴘᴛs', callback_data='encrypt')
        ], [
            ...
            InlineKeyboardButton('ɢɪɴғᴏ', callback_data='grpinfo'),
            InlineKeyboardButton('ᴛᴀɢᴀʟʟ', callback_data='tagall'),
            InlineKeyboardButton('ʙɢʀᴇᴍᴏᴠᴇ', callback_data='bgremove')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('ꜱᴘᴇᴄɪᴀʟ', callback_data='special_mod1'),
            InlineKeyboardButton('ꜱᴘᴇᴄɪᴀʟ', callback_data='special_mod2')
        ], [
            InlineKeyboardButton('ᴇxᴛʀᴀ ғᴇᴀᴛᴜʀᴇs', callback_data='extra_mod')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ʜᴇʀᴇ', user_id=int(8894820520))
        ],[
        ...
        btn = [[
            InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ', user_id=int(8894820520))
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('☎️ ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ ᴛᴏ ᴋɴᴏᴡ ᴍᴏʀᴇ', user_id=int(8894820520))
        ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('• MOVIES •', url="https://t.me/movies_group9")
       ],[ 
            InlineKeyboardButton('• ʙᴀᴄᴋ •', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('• ᴏᴡɴᴇʀ •', user_id=int(8894820520)),
        ...
        buttons = [[
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='help'),
            InlineKeyboardButton('ᴏᴡɴᴇʀ', url="t.me/cosmic_freak")
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await client.edit_message_media(
            query.message.chat.id, 
...
async def auto_filter(client, msg, spoll=False):
    ...
    #     ]
        ...
        btn.insert(0, [
            InlineKeyboardButton("ᴘʀᴇᴍɪᴜᴍ", url=f"https://t.me/moviemarket_official/369"),
            InlineKeyboardButton("sᴇɴᴅ ᴀʟʟ", callback_data=f"sendfiles#{key}")
        ])
