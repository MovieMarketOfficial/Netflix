...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('• ᴍᴀsᴛᴇʀ •', url="https://t.me/Gurmeet01k"),
                    InlineKeyboardButton('• sᴜᴘᴘᴏʀᴛ •', url='https://t.me/moviemarket_offical')
                ],[
                    InlineKeyboardButton('• ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ •', url="https://t.me/moviemarket_official")
                  ]]
    ...
    if AUTH_CHANNEL and not await is_req_subscribed(client, message):
        ...
        btn = [
                [
                    ...
                    InlineKeyboardButton(
                        text="• ᴜᴘᴅᴀᴛᴇs •",
                        url="https://t.me/moviemarket_official"
                    ),
                ]
...
async def donate_command(client, message):
    buttons = [
        [
            InlineKeyboardButton("• ᴅᴏɴᴀᴛᴇ • ", url="https://t.me/moviemarket_official/396"),
            InlineKeyboardButton("• sᴜᴘᴘᴏʀᴛ •", url="https://t.me/moviemarket_offical")
        ]
    ]
    reply_markup = InlineKeyboardMarkup(buttons)
...
async def help_command(client, message):
    buttons = [
        [
            InlineKeyboardButton("• ᴏᴘᴇɴ ɪɴ ᴘʀɪᴠᴀᴛᴇ •", url="https://t.me/Filtermovie9_bot?start=help"),
        ]
    ]
    reply_markup = InlineKeyboardMarkup(buttons)
...
async def support_command(client, message):
    buttons = [
        [
            InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ", url="https://t.me/moviemarket_offical"),
            InlineKeyboardButton("ᴜᴘᴅᴀᴛᴇs", url="https://t.me/moviemarket_official")
        ]
    ]
    reply_markup = InlineKeyboardMarkup(buttons)
